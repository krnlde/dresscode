...
class ResponseHeader
{
	 ...
	 *
	 * @return \Dresscode\ResponseHeader $this
	 */
	...
	public function add($type, $value = '')
	{
		...
		throw new \Dresscode\Exception('Cannot add a buffer. Response Header already sent.');
	}
	...
	public function remove($type)
	{
		...
		throw new \Dresscode\Exception('Cannot remove a buffer. Response Header already sent.');
	}
}