...
class Event
{
	 ...
	 * @param mixed $value
	 * @return void
	 * @throws \Dresscode\Exception\NotAllowed
	 */
	public function __set($var, $value)
	{
		throw new \Dresscode\Exception\NotAllowed('Set variable');
	}
